...
export const RefreshIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || "w-6 h-6"}>
    <path fillRule="evenodd" d="M4.755 10.059a7.5 7.5 0 0 1 12.548-3.364l1.903 1.903h-4.5a.75.75 0 0 0-.75.75v4.5l1.903-1.903a.75.75 0 0 0-1.06-1.061l-1.904 1.903ZM10.725 18.941a7.5 7.5 0 0 0 12.548-3.364l1.903 1.903h-4.5a.75.75 0 0 1-.75.75v4.5l1.903-1.903a.75.75 0 0 1-1.06-1.061l-1.904 1.903Z" clipRule="evenodd" />
  </svg>
);
